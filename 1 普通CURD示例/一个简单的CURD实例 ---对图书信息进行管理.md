...
**目录**
* [1 开发环境](#1开发环境)
  * [1.1 前端开发环境](#1.1前端开发环境)
  * [1.2 后端开发环境](#1.2后端开发环境)
* [2 数据库设计与创建](#2数据库设计与创建)
  * [2.1 数据库和表设计](# 2.1数据库和表设计)
  * [2.2 book表设计](#2.2 book表设计)
  * [2.3 sql语句编写](#2.3 sql语句编写)
* [3 后台模块开发](#3 后台模块开发)
  * [3.1 创建数据库连接](#3.1 创建数据库连接)
  * [3.2 创建表模型](#3.2 创建表模型)
  * [3.3 编写接口](#3.3 编写接口)
  * [3.4 接口测试](#3.4 接口测试)
## 1 开发环境
