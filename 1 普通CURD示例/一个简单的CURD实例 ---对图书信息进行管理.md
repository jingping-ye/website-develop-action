...
autoauto- [一个简单的 CURD 实例 ---对图书信息进行管理](#一个简单的-curd-实例----对图书信息进行管理)auto - [1 开发环境](#1-开发环境)auto - [1.1 前端开发环境](#11-前端开发环境)auto - [1.2 后端开发环境](#12-后端开发环境)auto - [2 数据库设计和创建](#2-数据库设计和创建)auto - [2.1 数据库和表设计](#21-数据库和表设计)auto - [2.2 book 表设计](#22-book-表设计)auto - [2.3 sql 语句编写](#23-sql-语句编写)auto - [3 后台模块开发](#3-后台模块开发)auto - [3.1 创建数据库连接](#31-创建数据库连接)auto - [3.2 创建表模型](#32-创建表模型)auto - [3.3 编写接口](#33-编写接口)auto - [3.4 接口测试](#34-接口测试)autoauto
